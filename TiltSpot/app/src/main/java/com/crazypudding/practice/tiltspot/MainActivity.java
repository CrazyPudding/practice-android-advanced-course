...
package com.crazypudding.practice.tiltspot;
...
public class MainActivity extends AppCompatActivity
    ...
    // Float array to hold copies of data
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        // Get the sensor type from the sensorEvent
        ...
        // avoid doing a lot of work in the onSensorChanged, use an AsyncTask.
        new SensorChangeTask().execute(mAccelerometerData, mMagnetometerData);
    }
    ...
    class SensorChangeTask extends AsyncTask<float[], Void, float[]> {

        @Override
        protected float[] doInBackground(float[]... floats) {
            // Translate coordinate system to earth's coordinate system
            float[] rotationMatrix = new float[9];
            boolean rotationOk = SensorManager.getRotationMatrix(rotationMatrix, null, floats[0], floats[1]);

            // Get the orientation angles from the rotationMatrix
            float[] orientationValues = new float[3];
            if (rotationOk) {
                SensorManager.getOrientation(rotationMatrix, orientationValues);
            }

            // get device rotation and remap the coordinate system
            ...
            // get the orientation angles from the rotationMatrixAdjusted
            return SensorManager.getOrientation(rotationMatrixAdjusted, orientationValues);
        }
